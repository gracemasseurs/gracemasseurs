...
var reset = new ShapeButton("Reset", 534, 24, 120, 40, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
var undo = new ShapeButton("Undo", 664, 24, 120, 40, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
...
objectSet.push(butOne, butTwo, butThree, butFour, reset, undo, colOne, colTwo, colThree, colFour, colFive, colSix, colSeven,colEight, colNine, colTen, colEleven, colTwelve, colThirteen, colFourteen, colFifteen, colSixteen, colSeventeen, colEighteen, colNineteen, colTwenty, colTwentyone);
