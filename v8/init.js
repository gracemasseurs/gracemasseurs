...
var colArray=[
    ...
    "rgba(255, 153, 153)","rgba(255, 77, 77,1)","rgba(255, 26, 26,1)",
    "rgba(255, 179, 128,1)","rgba(255, 148, 77,1)","rgba(255, 117, 26,1)"
    ],
    [
      "rgba(255, 255, 153,1)", "rgba(255, 255, 77,1)", "rgba(255, 255, 0,1)", 
    "rgba(153, 255, 153,1)","rgba(102, 255, 102,1)","rgba(0, 230, 0,1)",
    "rgba(153, 214, 255,1)","rgba(77, 184, 255,1)","rgba(0, 153, 255,1)",
    "rgba(221, 153, 255,1)", "rgba(204, 102, 255,1)", "rgba(179, 26, 255,1)"
    ],
    [
