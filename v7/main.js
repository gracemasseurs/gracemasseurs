...
var butThree = new ShapeButton("Circle", 25, 136, 120, 40, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);

var reset = new ShapeButton("Reset", 25, 192, 120, 40, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
var undo = new ShapeButton("Undo", 25, 248, 120, 40, colArray[0][1], colArray[0][1], colArray[2][2], colArray[2][0], canvas);
...
objectSet.push(butOne, butTwo, butThree, reset, undo, colOne, colTwo, colThree, colFour, colFive, colSix, colSeven,colEight, colNine, colTen, colEleven, colTwelve, colThirteen, colFourteen, colFifteen, colSixteen, colSeventeen, colEighteen, colNineteen, colTwenty, colTwentyone);
